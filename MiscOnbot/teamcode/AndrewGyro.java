...
@TeleOp
public class AndrewGyro extends LinearOpMode
{
    
    private ModernRoboticsI2cRangeSensor rightRangeSensor = null; //
    private ModernRoboticsI2cRangeSensor backRangeSensor = null;
    ...
    private ColorSensor topSensor = null;
    ...
    private int target,divisor=3,down=530;
    ...
    public void runOpMode()
    {
        ...
        backRangeSensor = hardwareMap.get(ModernRoboticsI2cRangeSensor.class, "backRange");
        ...
        if(numberRings==0){
            ...
            armPosition(down-degreeFactor, 0.5);//drops goal
            clawPosition(0.5);
            ...
            armPosition(down-degreeFactor, 0.5);//drops goal
            clawPosition(0.5);
            backward(2.5,1.0,north);//backs up to line. Change this
    ...
    public void printData(){
        telemetry.addData("backSensor:", backRangeSensor.rawUltrasonic());
        telemetry.addData("rightSensor:", rightRangeSensor.rawUltrasonic());
        angles = imu.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
    ...
    // public getDistanceInches(long microseconds) {
